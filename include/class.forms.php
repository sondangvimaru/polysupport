...
class FormField {
   ...
   function render($options=array()) {
    $emlement=  $this->getWidget();
    
 
        $rv = $this->getWidget()->render($options);
      if(count(FormField::$list_name)>=3) {
        FormField::$list_name=array();
      } 
      array_push(FormField::$list_name,$rv); 
...
class TextboxWidget extends Widget {
    ...
    function render($options=array(), $extraConfig=false) {
        ...
        <input  class="form-control" style="width: 98%;" type="<?php echo $type; ?>"
            id="<?php echo $this->id; ?>"
        ...
        <?php
                ...
                ?>
                 ...
                 <select data-role="select"  id="<?php echo $this->id; ?>"  
            name="<?php echo $this->name; ?>"
            value="<?php echo Format::htmlchars($this->value, true); ?>"  style="width: 98%;" >
         
                   <option value="0"  disabled selected >  --Chọn Dịch vụ muốn hỗ trợ--</option>
    ...
    function render2($options=array(), $extraConfig=false) {
...
class TextareaWidget extends Widget {
    function render($options=array()) {
        ...
        <textarea  style="width: 98%;" <?php echo Format::array_implode('=', ' ',
                array_filter($attrs)); ?>
            id="<?php echo $this->id; ?>"
...
class PhoneNumberWidget extends Widget {
    function render($options=array()) {
        ...
        ?>
        <input class="form-control" style="width: 98%;" id="<?php echo $this->id; ?>" type="tel" name="<?php echo $this->name; ?>" value="<?php
    ...
    function render2($options=array()) {
...
class ThreadEntryWidget extends Widget {
    function render($options=array()) {
        ...
        <textarea style="width:100%;" name="<?php echo $this->name; ?>"
            placeholder="<?php echo Format::htmlchars(($this->field->get('placeholder')=="Details on the reason(s) for opening the ticket.")?"Mô tả chi tiết về lý do mà cần sự hỗ trợ này":$this->field->get('placeholder')); ?>"
