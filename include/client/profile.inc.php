...
<p style="text-align: center;">
    <input class="btn btn-outline-primary" type="submit" value="<?php echo __('Update'); ?>"/>
    <input class="btn btn-outline-primary" type="reset" value="<?php echo __('Reset'); ?>"/>
    <input class="btn btn-outline-primary" type="button" value="<?php echo __('Cancel'); ?>" onclick="javascript:
